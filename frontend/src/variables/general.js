...
const Claims = {
  ...
  "P4":[{value:"C4-1", name:"Test Driven Development is not nessery for software development"},
        {value:"C4-2", name:"Software developers would benefit from using Test Driven Development"},
        {value:"C4-3", name:"Test Driven Development also effects the design of the software"},
        {value:"C4-4", name:"Test Driven Development would harm for the software quality"}],
